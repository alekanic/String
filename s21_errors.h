...
static const s21_error_t s21_error_list[] = {
    ...
    S21_ADD_ERR(S21_ERR_84, "Invalid or incomplete multibyte or wide character"),
    ...
    S21_ADD_ERR(S21_ERR_99, "Network is down"),
    S21_ADD_ERR(S21_ERR_100, "Network is unreachable"),
    S21_ADD_ERR(S21_ERR_101, "Network dropped connection on reset"),
    S21_ADD_ERR(S21_ERR_102, "Software caused connection abort"),
    S21_ADD_ERR(S21_ERR_103, "Connection reset by peer"),
    S21_ADD_ERR(S21_ERR_104, "No buffer space available"),
    S21_ADD_ERR(S21_ERR_105, "Transport endpoint is already connected"),
    S21_ADD_ERR(S21_ERR_106, "Transport endpoint is not connected"),
