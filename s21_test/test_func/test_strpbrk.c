...
START_TEST(s21_strpbrk_test) {
  const char strpbrk_test1[] = "hello world";
  const char strpbrk_accept1[] = "abcde";
  ck_assert_ptr_eq(s21_strpbrk(strpbrk_test1, strpbrk_accept1),
                   strpbrk(strpbrk_test1, strpbrk_accept1));

  const char strpbrk_test2[] = "test string";
  const char strpbrk_accept2[] = "xyz";
  ck_assert_ptr_null(s21_strpbrk(strpbrk_test2, strpbrk_accept2));

  const char strpbrk_test3[] = "123456789";
  const char strpbrk_accept3[] = "987";
